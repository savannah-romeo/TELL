...
namespace UnityUITable
{
	...
	public class InputCellStyle : InteractableCellStyle
	{
		...
		public StringSetting placeholderText = new StringSetting(
			(cell, v) => ((InputCell)cell).inputField.placeholder.GetComponent<Text>().text = v,
			(cell => ((InputCell)cell).inputField.placeholder.GetComponent<Text>().text));
